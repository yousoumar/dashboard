import "./chunk-JFPDOVUJ.js";
import {
  addDays,
  createPlugin
} from "./chunk-PUYRCZTC.js";
import {
  __commonJS,
  __toESM
} from "./chunk-ASLTLD6L.js";

// ../node_modules/.pnpm/ical.js@1.5.0/node_modules/ical.js/build/ical.js
var require_ical = __commonJS({
  "../node_modules/.pnpm/ical.js@1.5.0/node_modules/ical.js/build/ical.js"(exports, module) {
    var ICAL2;
    (function() {
    ...
    ICAL2.Component = function() {
      ...
      Component2.prototype = {
        ...
        _hydrateComponent: function(index2) {
          if (!this._components) {
            this._components = [];
        ...
        _hydrateProperty: function(index2) {
          if (!this._properties) {
            this._properties = [];
        ...
        _removeObjectByIndex: function(jCalIndex, cache, index2) {
          cache = cache || [];
          if (cache[index2]) {
            var obj = cache[index2];
            if ("parent" in obj) {
              obj.parent = null;
            }
          }
    ...
    ICAL2.Property = function() {
      ...
      Property.prototype = {
         ...
         */
        _setDecoratedValue: function(value, index2) {
          if (!this._values) {
            this._values = [];
          }
...
// ../node_modules/.pnpm/@fullcalendar+icalendar@6.1.13_@fullcalendar+core@6.1.13_ical.js@1.5.0/node_modules/@fullcalendar/icalendar/index.js
...
//# sourceMappingURL=@fullcalendar_icalendar.js.map
